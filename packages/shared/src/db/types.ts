// Generated from Supabase project: x-sentiments (sfpactmxaiyvsmrhfljt)
// Run: supabase gen types typescript --project-id sfpactmxaiyvsmrhfljt > packages/shared/src/db/types.ts
